    ...
    try:
        ...
        for count, scan in enumerate(scan_generator()):
            ...
            if results and current_round["r"] > INITIAL_ROUNDS_IGNORED:
                ...
                [angle for angle, distance, quality in zip(results[0], results[1], results[2]) if distance > distance_threshold and quality > quality_threshold],

                [distance for distance, quality in zip(results[1], results[2]) if distance > distance_threshold and quality > quality_threshold],

                [quality for quality in results[2] if quality > quality_threshold]
