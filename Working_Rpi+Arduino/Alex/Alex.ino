...
void left(float ang, float speed) {
  ...
  //dbprintf("%d,%d,%d,%d\n",deltaTicks, targetTicks, leftReverseTicksTurns,rightForwardTicksTurns);
}
...
void right(float ang, float speed) {
  ...
  cw(ang,speed * 2);
  //dbprintf("%d,%d,%d,%d\n",deltaTicks, targetTicks, rightReverseTicksTurns,leftForwardTicksTurns);
}
...
//dbprintf("R\n");
  ...
  rightDist = rightRevs * WHEEL_CIRC;\
  */
}
